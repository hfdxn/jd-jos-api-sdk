...
class EclpCoTransportLasWayBillRequest
{
	...
	public function getSaleOrderNo(){
	  return $this->saleOrderNo;
                        	                   			...
                        	                   			private $upstairsFlag;
    	                        
	public function setUpstairsFlag($upstairsFlag){
		$this->upstairsFlag = $upstairsFlag;
         $this->apiParas["upstairsFlag"] = $upstairsFlag;
	}

	public function getUpstairsFlag(){
	...
	public function setBackerName($backerName){
		$this->backerName = $backerName;
         $this->apiParas["backerName"] = $backerName;
	}

	public function getBackerName(){
	  return $this->backerName;
	}

                        	                   			private $backerMobile;
    	                        
	public function setBackerMobile($backerMobile){
		$this->backerMobile = $backerMobile;
         $this->apiParas["backerMobile"] = $backerMobile;
	}

	public function getBackerMobile(){
	  return $this->backerMobile;
	}

                        	                   			private $backerPhone;
    	                        
	public function setBackerPhone($backerPhone){
		$this->backerPhone = $backerPhone;
         $this->apiParas["backerPhone"] = $backerPhone;
	}

	public function getBackerPhone(){
	  return $this->backerPhone;
	}

                        	                   			private $backerAddress;
    	                        
	public function setBackerAddress($backerAddress){
		$this->backerAddress = $backerAddress;
         $this->apiParas["backerAddress"] = $backerAddress;
	}

	public function getBackerAddress(){

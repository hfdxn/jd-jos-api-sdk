...
class EclpGoodsTransportGoodsInfoRequest
{
	...
	public function getTransportInsured(){
	  return $this->transportInsured;
                        	                   			...
                        	                   			private $isBillingSplit;
    	                        
	public function setIsBillingSplit($isBillingSplit){
		$this->isBillingSplit = $isBillingSplit;
         $this->apiParas["isBillingSplit"] = $isBillingSplit;
	}

	public function getIsBillingSplit(){
	...
	public function getSource(){
	  return $this->source;
                        	                   			...
                        	                   			private $medicineCategoryCode;
    	                        
	public function setMedicineCategoryCode($medicineCategoryCode){
		$this->medicineCategoryCode = $medicineCategoryCode;
         $this->apiParas["medicineCategoryCode"] = $medicineCategoryCode;
	}

	public function getMedicineCategoryCode(){
	  return $this->medicineCategoryCode;
	}

                        	                   			private $warehouseTransfer;
    	                        
	public function setWarehouseTransfer($warehouseTransfer){
		$this->warehouseTransfer = $warehouseTransfer;
         $this->apiParas["warehouseTransfer"] = $warehouseTransfer;
	}
	...
	public function getWarehouseTransfer(){
	  return $this->warehouseTransfer;
                                                 	                        	                                                                                                                                                                                                                                                                                        ...
                                                 	                        	                                                                                                                                                                                                                                                                                        private $boxLevelNo;
                              public function setBoxLevelNo($boxLevelNo ){
                 $this->boxLevelNo=$boxLevelNo;
                 $this->apiParas["boxLevelNo"] = $boxLevelNo;
              }

              public function getBoxLevelNo(){
              	return $this->boxLevelNo;
              }
                                                                                                                                                                                                                                                                                                                       private $boxLevelName;
                              public function setBoxLevelName($boxLevelName ){
                 $this->boxLevelName=$boxLevelName;
                 $this->apiParas["boxLevelName"] = $boxLevelName;
              }

              public function getBoxLevelName(){
              	return $this->boxLevelName;
              }
                                                                                                                                                                                                                                                                                                                       private $boxLength;
                              public function setBoxLength($boxLength ){
                 $this->boxLength=$boxLength;
                 $this->apiParas["boxLength"] = $boxLength;
              }
              ...
              public function getBoxLength(){
                 ...
                 $this->apiParas["boxWidth"] = $boxWidth;
              }
              ...
              public function getBoxWidth(){
                 ...
                 $this->apiParas["boxHeight"] = $boxHeight;
              }
              ...
              public function getBoxHeight(){
              	return $this->boxHeight;
                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                       private $boxNum;
                              public function setBoxNum($boxNum ){
                 $this->boxNum=$boxNum;
                 $this->apiParas["boxNum"] = $boxNum;
              }

              public function getBoxNum(){
              	return $this->boxNum;
              }
                                                                                                                                                                                                                                                                                                                       private $boxGrossWeight;
                              public function setBoxGrossWeight($boxGrossWeight ){
                 $this->boxGrossWeight=$boxGrossWeight;
                 $this->apiParas["boxGrossWeight"] = $boxGrossWeight;
              }

              public function getBoxGrossWeight(){
	...
	public function setBillingSpecs($billingSpecs){
		$this->billingSpecs = $billingSpecs;
         $this->apiParas["billingSpecs"] = $billingSpecs;
	}

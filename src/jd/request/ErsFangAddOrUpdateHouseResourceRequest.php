...
class ErsFangAddOrUpdateHouseResourceRequest
{
	...
	public function setVrUrl($vrUrl){
		$this->vrUrl = $vrUrl;
         $this->apiParas["vrUrl"] = $vrUrl;
	}

	public function getVrUrl(){
	  return $this->vrUrl;
	}
	...
	public function getBrandId(){
	  return $this->brandId;
                        	                   			...
                        	                   			private $elevatorLabel;
    	                        
	public function setElevatorLabel($elevatorLabel){
		$this->elevatorLabel = $elevatorLabel;
         $this->apiParas["elevatorLabel"] = $elevatorLabel;
	}

	public function getElevatorLabel(){

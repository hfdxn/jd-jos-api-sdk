...
class EclpCoTransportReverseLasWaybillRequest
{
	...
	public function getGuaranteeValue(){
	  return $this->guaranteeValue;
                        	                   			...
                        	                   			private $isDoorToDoorRecycle;
    	                        
	public function setIsDoorToDoorRecycle($isDoorToDoorRecycle){
		$this->isDoorToDoorRecycle = $isDoorToDoorRecycle;
         $this->apiParas["isDoorToDoorRecycle"] = $isDoorToDoorRecycle;
	}

	public function getIsDoorToDoorRecycle(){

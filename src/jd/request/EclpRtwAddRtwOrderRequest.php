...
class EclpRtwAddRtwOrderRequest
{
	...
	public function getSalesPlatformNo(){
	  return $this->salesPlatformNo;
                        	                   			...
                        	                   			private $relatedOrderNo;
    	                        
	public function setRelatedOrderNo($relatedOrderNo){
		$this->relatedOrderNo = $relatedOrderNo;
         $this->apiParas["relatedOrderNo"] = $relatedOrderNo;
	}

	public function getRelatedOrderNo(){
	  return $this->relatedOrderNo;
	}

                        	                   			private $serialVersion;
    	                        
	public function setSerialVersion($serialVersion){
		$this->serialVersion = $serialVersion;
         $this->apiParas["serialVersion"] = $serialVersion;
	}

	public function getSerialVersion(){
	  return $this->serialVersion;
	}

                        	                   			private $serialBizType;
    	                        
	public function setSerialBizType($serialBizType){
		$this->serialBizType = $serialBizType;
         $this->apiParas["serialBizType"] = $serialBizType;
	}

	public function getSerialBizType(){

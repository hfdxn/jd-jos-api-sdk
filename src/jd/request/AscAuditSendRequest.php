...
class AscAuditSendRequest
{
	...
	public function getPickDetctPaper(){
	  return $this->pickDetctPaper;
                        	                   	                    		...
                        	                   	                    		private $applyDetailIdLongList;
    	                        
	public function setApplyDetailIdLongList($applyDetailIdLongList){
		$this->applyDetailIdLongList = $applyDetailIdLongList;
         $this->apiParas["applyDetailIdLongList"] = $applyDetailIdLongList;
	}

	public function getApplyDetailIdLongList(){

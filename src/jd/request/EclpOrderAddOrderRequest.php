...
class EclpOrderAddOrderRequest
{
	...
	public function setYardInner($yardInner){
		$this->yardInner = $yardInner;
         $this->apiParas["yardInner"] = $yardInner;
	}

	public function getYardInner(){
	  return $this->yardInner;
	}

                        	                   			private $warehouseProductNo;
    	                        
	public function setWarehouseProductNo($warehouseProductNo){
		$this->warehouseProductNo = $warehouseProductNo;
         $this->apiParas["warehouseProductNo"] = $warehouseProductNo;
	}

	public function getWarehouseProductNo(){
	  return $this->warehouseProductNo;
	}

                        	                   			private $deliveryProductNo;
    	                        
	public function setDeliveryProductNo($deliveryProductNo){
		$this->deliveryProductNo = $deliveryProductNo;
         $this->apiParas["deliveryProductNo"] = $deliveryProductNo;
	}

	public function getDeliveryProductNo(){
	  ...
	  return $this->payTime;
              ...
              public function getBatAttrRangeJson(){
              	return $this->batAttrRangeJson;
                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                       private $cloudPrintInfoJson;
                              public function setCloudPrintInfoJson($cloudPrintInfoJson ){
                 $this->cloudPrintInfoJson=$cloudPrintInfoJson;
                 $this->apiParas["cloudPrintInfoJson"] = $cloudPrintInfoJson;
              }

              public function getCloudPrintInfoJson(){

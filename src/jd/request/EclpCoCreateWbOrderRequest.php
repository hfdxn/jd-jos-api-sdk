...
class EclpCoCreateWbOrderRequest
{
	  ...
	  return $this->checkPreSort;
              ...
              public function getHeavyUpstairSplit(){
              	return $this->heavyUpstairSplit;
                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                              private $hospitalServicesYYSplit;
                              public function setHospitalServicesYYSplit($hospitalServicesYYSplit ){
                 $this->hospitalServicesYYSplit=$hospitalServicesYYSplit;
                 $this->apiParas["hospitalServicesYYSplit"] = $hospitalServicesYYSplit;
              }

              public function getHospitalServicesYYSplit(){
	...
	public function getFileWithCargo(){
	  return $this->fileWithCargo;
                        	                   			...
                        	                   			private $hospitalServicesYY;
    	                        
	public function setHospitalServicesYY($hospitalServicesYY){
		$this->hospitalServicesYY = $hospitalServicesYY;
         $this->apiParas["hospitalServicesYY"] = $hospitalServicesYY;
	}

	public function getHospitalServicesYY(){
